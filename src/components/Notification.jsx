...
const Notification = ({message, onClose, handleClose, progress}) => {
  ...
  return (
    ...
    <div className={`flex justify-between items-center py-2 transition-all duration-700  px-4 bg-gradient-to-tr from-purple-500 via-green-500 to to-blue-500 from-opacity-100  to-opacity-0 `}>
      <h2 className='text-center w-full text-white'>{message}</h2>
      <MdClose onClick={handleClose} className='absolute text-white' size={20}/>
      </div>
